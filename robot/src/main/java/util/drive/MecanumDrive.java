...
public class MecanumDrive extends Drive {
    ...
    private edu.wpi.first.wpilibj.drive.MecanumDrive mecanumDrive;
    ...
    public MecanumDrive(DreadbotMotor leftFrontMotor, DreadbotMotor rightFrontMotor, DreadbotMotor leftBackMotor,
